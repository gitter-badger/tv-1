...
if(!extension_loaded('Music'))include_once 'Music.php';
use API\Music;
...
switch(getParam('types'))   // 根据请求的 Api，执行相应操作
{
    ...
    case 'search':  // 搜索歌曲
        ...
        break;        
    default:
        echo '<!doctype html><html><head><meta charset="utf-8"><title>信息</title><style>* {font-family: microsoft yahei}</style></head><body> <h2>VIP云视听</h2>';
